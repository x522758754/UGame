...
UGAT_PlayMontageAndWaitForEvent* UGAT_PlayMontageAndWaitForEvent::PlayMontageAndWaitForEvent(UGameplayAbility* OwningAbility, FName TaskInstanceName, UAnimMontage* MontageToPlay,FGameplayTagContainer EventTags, float Rate, FName StartSection, bool bStopWhenAbilityEnds,float AnimRootMotionTranslationScale)
{
	UAbilitySystemGlobals::NonShipping_ApplyGlobalAbilityScaler_Rate(Rate);

	UGAT_PlayMontageAndWaitForEvent* MyObj = NewAbilityTask<UGAT_PlayMontageAndWaitForEvent>(OwningAbility, TaskInstanceName);
