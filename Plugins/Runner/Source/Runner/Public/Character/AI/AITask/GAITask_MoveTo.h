...
#include "GAITask_MoveTo.generated.h"
...
UCLASS()
class UGAITask_MoveTo : public UAITask
{
	GENERATED_BODY()

public:
	UGAITask_MoveTo(const FObjectInitializer& ObjectInitializer);
	...
	static UGAITask_MoveTo* AIMoveTo(AAIController* Controller, FVector GoalLocation, AActor* GoalActor = nullptr,
