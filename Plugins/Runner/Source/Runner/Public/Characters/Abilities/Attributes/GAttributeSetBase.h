...
#include "GAttributeSetBase.generated.h"
 ...
 */
UCLASS()
class RUNNER_API UGAttributeSetBase : public UAttributeSet
{
	GENERATED_BODY()
public:
	UGAttributeSetBase();
...
// AttributeSet Overrides
	...
	ATTRIBUTE_ACCESSORS(UGAttributeSetBase, Health)

	// MaxHealth is its own attribute since GameplayEffects may modify it
	UPROPERTY(BlueprintReadOnly, Category = "Health", ReplicatedUsing = OnRep_MaxHealth)
	FGameplayAttributeData MaxHealth;
	ATTRIBUTE_ACCESSORS(UGAttributeSetBase, MaxHealth)

	// Health regen rate will passively increase Health every second
	UPROPERTY(BlueprintReadOnly, Category = "Health", ReplicatedUsing = OnRep_HealthRegenRate)
	FGameplayAttributeData HealthRegenRate;
	ATTRIBUTE_ACCESSORS(UGAttributeSetBase, HealthRegenRate)

	// Current Mana, used to execute special abilities. Capped by MaxMana.
	UPROPERTY(BlueprintReadOnly, Category = "Mana", ReplicatedUsing = OnRep_Mana)
	FGameplayAttributeData Mana;
	ATTRIBUTE_ACCESSORS(UGAttributeSetBase, Mana)

	// MaxMana is its own attribute since GameplayEffects may modify it
	UPROPERTY(BlueprintReadOnly, Category = "Mana", ReplicatedUsing = OnRep_MaxMana)
	FGameplayAttributeData MaxMana;
	ATTRIBUTE_ACCESSORS(UGAttributeSetBase, MaxMana)
	...
	ATTRIBUTE_ACCESSORS(UGAttributeSetBase, XP)
	...
	ATTRIBUTE_ACCESSORS(UGAttributeSetBase, XPBounty)
	...
	ATTRIBUTE_ACCESSORS(UGAttributeSetBase, Gold)
	...
	ATTRIBUTE_ACCESSORS(UGAttributeSetBase, GoldBounty)
