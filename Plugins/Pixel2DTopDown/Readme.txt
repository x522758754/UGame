...
To install the templates go to the TemplateProjects folder and either double click the Install_Template_Topdown.bat or, if you want,you can manually unzip and copy the contents to a newly created folder called TP_Pixel2D_Topdown inside your Templates folder for the version of Unreal Engine you have the plugin installed to.
