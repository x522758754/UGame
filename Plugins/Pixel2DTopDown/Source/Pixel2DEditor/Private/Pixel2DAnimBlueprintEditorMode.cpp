...
{
	AnimBlueprintPtr = CastChecked<UPixel2DTDAnimBlueprint>(InAnimationBlueprintEditor->GetBlueprintObj());
	...
	IPixel2DAnimEditorModule& Pixel2DEditorModule = FModuleManager::LoadModuleChecked<IPixel2DAnimEditorModule>("Pixel2DEditorTD");
