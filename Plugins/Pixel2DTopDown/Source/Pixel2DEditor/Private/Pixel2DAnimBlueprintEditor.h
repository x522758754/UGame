...
public:
	...
	void InitSpriteAnimBlueprintEditor(const EToolkitMode::Type Mode, const TSharedPtr< class IToolkitHost >& InitToolkitHost, class UPixel2DTDAnimBlueprint* InSpriteAnimBlueprint);

public:

	// Gets the Anim Blueprint being edited/viewed by this Persona instance
	UPixel2DTDAnimBlueprint* GetSpriteAnimBlueprint() const;
