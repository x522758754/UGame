...
#include "Pixel2DTDAnimGraphSchema.generated.h"
...
UCLASS(MinimalAPI)
class UPixel2DTDAnimGraphSchema :  public UEdGraphSchema_K2
{
	...
	// @todo document
	PIXEL2DEDITORTD_API static bool IsPosePin(const FEdGraphPinType& PinType);

	// @todo document
	PIXEL2DEDITORTD_API static bool IsLocalSpacePosePin(const FEdGraphPinType& PinType);
};
