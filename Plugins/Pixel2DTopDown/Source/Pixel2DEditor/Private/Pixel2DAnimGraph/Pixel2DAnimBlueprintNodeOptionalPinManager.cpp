...
FPixel2DAnimBlueprintNodeOptionalPinManager::FPixel2DAnimBlueprintNodeOptionalPinManager(class UPixel2DTDAnimGraphNode_Base* Node, TArray<UEdGraphPin*>* InOldPins)
	: BaseNode(Node)
	, OldPins(InOldPins)
{
	if (OldPins)
...
void FPixel2DAnimBlueprintNodeOptionalPinManager::GetRecordDefaults(FProperty* TestProperty, FOptionalPinFromProperty& Record) const
{
   ...
   // Determine if this is a pose or array of poses
	...
	const bool bIsPoseInput = (StructProp != NULL) && (StructProp->Struct->IsChildOf(FPixel2DTDPoseLinkBase::StaticStruct()));
