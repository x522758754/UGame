...
#include "Pixel2DTDAnimGraphNode_Base.generated.h"
...
{
public:
	static FPixel2DTDPoseLinkMappingRecord MakeFromArrayEntry(UPixel2DTDAnimGraphNode_Base* LinkingNode, UPixel2DTDAnimGraphNode_Base* LinkedNode, FArrayProperty* ArrayProperty, int32 ArrayIndex)
	{
		checkSlow(CastChecked<FStructProperty>(ArrayProperty->Inner)->Struct->IsChildOf(FPixel2DTDPoseLinkBase::StaticStruct()));

		FPixel2DTDPoseLinkMappingRecord Result;
	...
	static FPixel2DTDPoseLinkMappingRecord MakeFromMember(UPixel2DTDAnimGraphNode_Base* LinkingNode, UPixel2DTDAnimGraphNode_Base* LinkedNode, FStructProperty* MemberProperty)
	{
		checkSlow(MemberProperty->Struct->IsChildOf(FPixel2DTDPoseLinkBase::StaticStruct()));
	...
	static FPixel2DTDPoseLinkMappingRecord MakeInvalid()
	{
		FPixel2DTDPoseLinkMappingRecord Result;
		return Result;
	}
	...
	UPixel2DTDAnimGraphNode_Base* GetLinkedNode() const
	{
		return LinkedNode;
	}

	UPixel2DTDAnimGraphNode_Base* GetLinkingNode() const
	{
		return LinkingNode;
	}

	PIXEL2DEDITORTD_API void PatchLinkIndex(uint8* DestinationPtr, int32 LinkID, int32 SourceLinkID) const;
protected:
...
protected:
	...
	UPixel2DTDAnimGraphNode_Base* LinkedNode;

	// Linking node for this pose link, can be nullptr
	UPixel2DTDAnimGraphNode_Base* LinkingNode;
...
*/
UCLASS(Abstract)
class PIXEL2DEDITORTD_API UPixel2DTDAnimGraphNode_Base : public UK2Node
{
	...
	virtual void ValidateAnimNodePostCompile(FCompilerResultsLog& MessageLog, UPixel2DTDAnimBlueprintGeneratedClass* CompiledClass, int32 CompiledNodeIndex) {}
	...
	UPixel2DTDAnimBlueprint* GetAnimBlueprint() const { return CastChecked<UPixel2DTDAnimBlueprint>(GetBlueprint()); }
	...
	*/
	...
	DECLARE_EVENT_OneParam(UPixel2DTDAnimGraphNode_Base, FOnNodePropertyChangedEvent, FPropertyChangedEvent&);
...
protected:
	...
	//
	virtual FPixel2DTDPoseLinkMappingRecord GetLinkIDLocation(const UScriptStruct* NodeType, UEdGraphPin* InputLinkPin);
