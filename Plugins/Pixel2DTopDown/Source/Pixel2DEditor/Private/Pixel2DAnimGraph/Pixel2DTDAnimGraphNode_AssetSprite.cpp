...
#include "Pixel2DTDAnimNotify.h"

/////////////////////////////////////////////////////
// UPixel2DTDAnimGraphNode_AssetSprite

#define LOCTEXT_NAMESPACE "A3Nodes"

UPixel2DTDAnimGraphNode_AssetSprite::UPixel2DTDAnimGraphNode_AssetSprite(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	NotifyProxy = NewObject<UPixel2DTDAnimNotify>();
	NotifyProxy->NotifyArray = &(Node.NotifyEvents);
}

void UPixel2DTDAnimGraphNode_AssetSprite::InitNotifyProxy()
{
...
FText UPixel2DTDAnimGraphNode_AssetSprite::GetTooltipText() const
{
	// FText::Format() is slow, so we utilize the cached list title
	return GetNodeTitle(ENodeTitleType::ListView);
}

FText UPixel2DTDAnimGraphNode_AssetSprite::GetNodeTitleForFlipbook(ENodeTitleType::Type TitleType, UPaperFlipbook* Flipbook) const
{
...
FText UPixel2DTDAnimGraphNode_AssetSprite::GetNodeTitle(ENodeTitleType::Type TitleType) const
{
...
// REVISIT
void UPixel2DTDAnimGraphNode_AssetSprite::GetMenuActions(FBlueprintActionDatabaseRegistrar& ActionRegistrar) const
{
...
void UPixel2DTDAnimGraphNode_AssetSprite::GetNodeContextMenuActions(class UToolMenu* Menu, class UGraphNodeContextMenuContext* Context) const
{
...
void UPixel2DTDAnimGraphNode_AssetSprite::SetAnimationAsset(UPaperFlipbook* Asset)
{
	{
...
EAnimAssetHandlerType UPixel2DTDAnimGraphNode_AssetSprite::SupportsAssetClass(const UClass* AssetClass) const
{
...
FName UPixel2DTDAnimGraphNode_AssetSprite::GetNotifyName(int32 NotifyIndex)
{
	return Node.GetNotifyName(NotifyIndex);
}

UPixel2DTDAnimNotify * UPixel2DTDAnimGraphNode_AssetSprite::GetNotify()
{
	// REVISIT
	//if (NotifyProxy == nullptr)
	//{
...
bool UPixel2DTDAnimGraphNode_AssetSprite::IsNotifyEnabled(int32 NotifyIndex)
{
	return Node.NotifyEvents[NotifyIndex].bEnabled;
}

TArray<FName> UPixel2DTDAnimGraphNode_AssetSprite::NotifyEventsNames()
{
	TArray<FName> RetVal;
