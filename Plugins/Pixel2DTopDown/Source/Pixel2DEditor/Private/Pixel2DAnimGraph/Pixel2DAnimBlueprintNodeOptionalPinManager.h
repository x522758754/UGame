...
{
protected:
	class UPixel2DTDAnimGraphNode_Base* BaseNode;
	TArray<UEdGraphPin*>* OldPins;

	TMap<FName, UEdGraphPin*> OldPinMap;

public:
	FPixel2DAnimBlueprintNodeOptionalPinManager(class UPixel2DTDAnimGraphNode_Base* Node, TArray<UEdGraphPin*>* InOldPins);
