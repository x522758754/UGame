...
void SPixel2DGraphNodeState::Construct(const FArguments& InArgs, UPixel2DTDAnimStateNodeBase* InNode)
{
...
{
	UPixel2DTDAnimStateNodeBase* StateNode = CastChecked<UPixel2DTDAnimStateNodeBase>(GraphNode);
...
void SPixel2DGraphNodeConduit::Construct(const FArguments& InArgs, UPixel2DTDAnimStateConduitNode* InNode)
{
