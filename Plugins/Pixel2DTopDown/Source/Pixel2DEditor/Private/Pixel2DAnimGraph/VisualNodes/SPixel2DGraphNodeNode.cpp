...
void SPixel2DGraphNodeNode::Construct(const FArguments& InArgs, UPixel2DTDAnimGraphNode_Base* InNode)
{
...
TArray<FOverlayWidgetInfo> SPixel2DGraphNodeNode::GetOverlayWidgets(bool bSelected, const FVector2D& WidgetSize) const
{
	...
	if (UPixel2DTDAnimGraphNode_Base* AnimNode = CastChecked<UPixel2DTDAnimGraphNode_Base>(GraphNode, ECastCheckedType::NullAllowed))
	{
