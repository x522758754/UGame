...
public:
	...
	void Construct(const FArguments& InArgs, UPixel2DTDAnimStateTransitionNode* InNode);
	...
	static FLinearColor StaticGetTransitionColor(UPixel2DTDAnimStateTransitionNode* TransNode, bool bIsHovered);
private:
