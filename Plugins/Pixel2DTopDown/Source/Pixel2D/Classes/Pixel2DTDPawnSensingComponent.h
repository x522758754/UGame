...
#include "Pixel2DTDPawnSensingComponent.generated.h"
...
class PIXEL2DTD_API UPixel2DTDPawnSensingComponent : public UActorComponent
{
...
inline float UPixel2DTDPawnSensingComponent::GetPeripheralVisionAngle() const
{
	return PeripheralVisionAngle;
}

inline float UPixel2DTDPawnSensingComponent::GetPeripheralVisionCosine() const
{
