...
FPixel2DTDTileMapRenderSceneProxy::FPixel2DTDTileMapRenderSceneProxy(const UPixel2DTDTileMapComponent* InComponent)
...
SIZE_T FPixel2DTDTileMapRenderSceneProxy::GetTypeHash() const
{
	static size_t UniquePointer;
	return reinterpret_cast<size_t>(&UniquePointer);
}

FPixel2DTDTileMapRenderSceneProxy* FPixel2DTDTileMapRenderSceneProxy::CreateTileMapProxy(const UPixel2DTDTileMapComponent* InComponent, TArray<FSpriteRenderSection>*& OutSections, TArray<FDynamicMeshVertex>*& OutVertices)
{
	FPixel2DTDTileMapRenderSceneProxy* NewProxy = new FPixel2DTDTileMapRenderSceneProxy(InComponent);
...
void FPixel2DTDTileMapRenderSceneProxy::FinishConstruction_GameThread()
{
}

void FPixel2DTDTileMapRenderSceneProxy::DrawBoundsForLayer(FPrimitiveDrawInterface* PDI, const FLinearColor& Color, int32 LayerIndex) const
{
...
void FPixel2DTDTileMapRenderSceneProxy::DrawNormalGridLines(FPrimitiveDrawInterface* PDI, const FLinearColor& PerTileColor, const FLinearColor& MultiTileColor, int32 MultiTileGridWidth, int32 MultiTileGridHeight, int32 MultiTileGridOffsetX, int32 MultiTileGridOffsetY, int32 LayerIndex) const
{
...
void FPixel2DTDTileMapRenderSceneProxy::DrawStaggeredGridLines(FPrimitiveDrawInterface* PDI, const FLinearColor& PerTileColor, const FLinearColor& MultiTileColor, int32 MultiTileGridWidth, int32 MultiTileGridHeight, int32 MultiTileGridOffsetX, int32 MultiTileGridOffsetY, int32 LayerIndex) const
{
	FLinearColor Color = PerTileColor;
	TArray<FVector> Poly;
	Poly.Empty(4);
...
void FPixel2DTDTileMapRenderSceneProxy::DrawHexagonalGridLines(FPrimitiveDrawInterface* PDI, const FLinearColor& PerTileColor, const FLinearColor& MultiTileColor, int32 MultiTileGridWidth, int32 MultiTileGridHeight, int32 MultiTileGridOffsetX, int32 MultiTileGridOffsetY, int32 LayerIndex) const
{
...
void FPixel2DTDTileMapRenderSceneProxy::GetDynamicMeshElements(const TArray<const FSceneView*>& Views, const FSceneViewFamily& ViewFamily, uint32 VisibilityMap, FMeshElementCollector& Collector) const
{
