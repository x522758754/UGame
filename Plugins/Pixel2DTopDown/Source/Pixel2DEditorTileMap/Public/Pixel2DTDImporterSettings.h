...
#include "Pixel2DTDImporterSettings.generated.h"
...
/**
 * Implements the settings for imported Pixel2D TopDown assets.
 */
UCLASS(config=Editor, defaultconfig)
class PIXEL2DEDITORTILEMAPTD_API UPixel2DTDImporterSettings : public UObject
{
	GENERATED_BODY()
...
public:
	...
	void ApplySettingsForTileMapInit(UPixel2DTDTileMap* TileMap, UPaperTileSet* DefaultTileSet = nullptr, ESpriteInitMaterialLightingMode LightingMode = ESpriteInitMaterialLightingMode::Automatic, ESpriteInitMaterialType MaterialTypeMode = ESpriteInitMaterialType::Automatic, bool bCreateEmptyLayer = true) const;
